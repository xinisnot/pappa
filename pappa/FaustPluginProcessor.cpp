/* ------------------------------------------------------------
name: "pappa"
Code generated with Faust 2.75.15 (https://faust.grame.fr)
...
struct mydsp : public base_dsp {
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = 255.0f - fSlow0;
		float fSlow2 = ((fSlow1 == 0.0f) ? 255.0f : fSlow1);
		int iSlow3 = int(fSlow1);
		int iSlow4 = int(float(fVslider1));
		float fSlow5 = fConst1 * float(fVslider2);
		float fSlow6 = fConst1 * float(fVslider3);
		int iSlow7 = int(std::min<float>(16384.0f, std::max<float>(1.0f, float(count)))) + 1;
		float fSlow8 = fConst1 * std::pow(1e+01f, 0.05f * float(fVslider4));
		float fSlow9 = 0.003921569f * fSlow0;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec6[0] = fSlow5 + fConst2 * fRec6[1];
			float fTemp0 = std::tan(fConst3 * std::pow(1e+01f, 3.0f * fRec6[0] + 1.0f));
			float fTemp1 = fTemp0 + 1.0f;
			float fTemp2 = 2.0f * (fTemp0 / fTemp1) + -1.0f;
			fRec7[0] = fSlow6 + fConst2 * fRec7[1];
			float fTemp3 = fRec7[0] + -0.70710677f;
			float fTemp4 = 0.0823286f * (mydsp_faustpower2_f(fTemp0) * fTemp3 * fTemp2 / mydsp_faustpower2_f(fTemp1)) + 1.0f;
			float fTemp5 = fTemp0 * fTemp2;
			fRec8[0] = fSlow8 + fConst2 * fRec8[1];
			float fTemp6 = fTemp0 * ((tanhf(fRec8[0] * fRec0[(IOTA0 - iSlow7) & 32767]) - fTemp3 * (0.1646572f * fRec2[1] + 0.0823286f * fRec4[1] * fTemp2 + 0.0823286f * (fTemp5 * fRec3[1] / fTemp1)) / fTemp1) / fTemp4 - fRec3[1]) / fTemp1;
			float fTemp7 = fTemp0 * (fRec3[1] + fTemp6 - fRec4[1]) / fTemp1;
			float fTemp8 = fRec4[1] + fTemp7;
			float fTemp9 = fTemp0 * (fTemp8 - fRec2[1]) / fTemp1;
			fRec2[0] = fRec2[1] + 2.0f * fTemp9;
			fRec3[0] = fRec3[1] + 2.0f * fTemp6;
			fRec4[0] = fRec4[1] + 2.0f * fTemp7;
			fRec5[0] = 2.0f * (fRec2[1] + fTemp9) - fTemp8;
			fRec1[0] = fRec5[0] + 0.995f * fRec1[1] - fRec5[1];
			fRec0[IOTA0 & 32767] = 255.0f * ((fSlow9 + 0.007843138f * float((int(127.5f * (float(input0[i0]) + fRec1[0] + 1.0f)) ^ iSlow4) & iSlow3) + -1.0f) / fSlow2);
			output0[i0] = FAUSTFLOAT(fRec0[IOTA0 & 32767]);
			float fTemp10 = fTemp0 * ((tanhf(fRec8[0] * fRec9[(IOTA0 - iSlow7) & 32767]) - fTemp3 * (0.1646572f * fRec11[1] + 0.0823286f * fTemp2 * fRec13[1] + 0.0823286f * (fTemp5 * fRec12[1] / fTemp1)) / fTemp1) / fTemp4 - fRec12[1]) / fTemp1;
			float fTemp11 = fTemp0 * (fRec12[1] + fTemp10 - fRec13[1]) / fTemp1;
			float fTemp12 = fRec13[1] + fTemp11;
			float fTemp13 = fTemp0 * (fTemp12 - fRec11[1]) / fTemp1;
			fRec11[0] = fRec11[1] + 2.0f * fTemp13;
			fRec12[0] = fRec12[1] + 2.0f * fTemp10;
			fRec13[0] = fRec13[1] + 2.0f * fTemp11;
			fRec14[0] = 2.0f * (fRec11[1] + fTemp13) - fTemp12;
			fRec10[0] = fRec14[0] + 0.995f * fRec10[1] - fRec14[1];
			fRec9[IOTA0 & 32767] = 255.0f * ((fSlow9 + 0.007843138f * float((int(127.5f * (float(input1[i0]) + fRec10[0] + 1.0f)) ^ iSlow4) & iSlow3) + -1.0f) / fSlow2);
	...
	#define FAUST_FILE_NAME "pappa.dsp"
